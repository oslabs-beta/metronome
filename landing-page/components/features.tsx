      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">The majority of developers lorem ipsum ipsum</h2>
            <p className="text-xl text-gray-400">with metronome, you'll be able to find (add stuff)</p>
          </div>
