        ...
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none">
            ...
            <div className="flex flex-col h-full p-6 bg-gray-800 text-center" data-aos="fade-up">
              <div>
                <div className="relative inline-flex flex-col align-middle">
                  <Image className="rounded-full" src={Bruce} width={100} height={100} alt="Testimonial 01" />
                </div>
              </div>
              <div className="text-gray-700 font-medium mt-6 pt-5 border-t border-gray-700">
                <p className="text-gray-200 not-italic">Bruce Onuigbo</p><p className="text-purple-600">Full-Stack Software Engineer</p>
              </div>
            </div>
            ...
            <div className="flex flex-col h-full p-6 bg-gray-800 text-center" data-aos="fade-up">
              ...
              <div className="text-gray-700 font-medium mt-6 pt-5 border-t border-gray-700">
                <p className="text-gray-200 not-italic">Jeanine Peters</p><p className="text-purple-600">Full-Stack Software Engineer</p>
              </div>
            </div>
            ...
            <div className="flex flex-col h-full p-6 bg-gray-800 text-center" data-aos="fade-up">
              ...
              <div className="text-gray-700 font-medium mt-6 pt-5 border-t border-gray-700">
                <p className="text-gray-200 not-italic">Lisandro Olivares</p><p className="text-purple-600">Full-Stack Software Engineer</p>
              </div>
            </div>
            ...
            <div className="flex flex-col h-full p-6 bg-gray-800 text-center" data-aos="fade-up">
              ...
              <div className="text-gray-700 font-medium mt-6 pt-5 border-t border-gray-700">
                <p className="text-gray-200 not-italic">Vicky Liu</p><p className="text-purple-600">Full-Stack Software Engineer</p>
              </div>
            </div>
            ...
            <div className="flex flex-col h-full p-6 bg-gray-800 text-center" data-aos="fade-up">
              ...
              <div className="text-gray-700 font-medium mt-6 pt-5 border-t border-gray-700">
                <p className="text-gray-200 not-italic">Zai Sugino</p><p className="text-purple-600">Full-Stack Software Engineer</p>
              </div>
            </div>
